                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="{!! route('reactor.nodetypes.fields', $nodetype->getKey()) !!}"><i
                                            class="fa fa-ellipsis-v "></i> Fields</a></li>
                            <li><a href="{!! route('reactor.nodetypes.nodes', $nodetype->getKey()) !!}"><i
                                            class="fa fa-ellipsis-v "></i> Nodes</a></li>
